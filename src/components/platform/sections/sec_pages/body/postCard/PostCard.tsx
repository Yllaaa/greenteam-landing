...
function PostCard(props: Props) {
  ...
  }, [subTopic, page, mainTopic, isLoading, accessToken, isMounted, slug]);
  ...
  const navigateToPost = useCallback(
    (postId: string) => {
      router.push(`/${locale}/feeds/posts/${postId}?slug=${slug}`);
    },
    [router, locale, slug]
  );
        ...
        {postContent.map((post, index) => (
          ...
          >
            ...
            <div className={styles.header}>
              <div
                onClick={() =>
                  navigateToProfile(post.author.username, "page")
                }
