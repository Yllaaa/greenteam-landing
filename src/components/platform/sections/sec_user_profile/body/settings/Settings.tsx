...
function Settings(props: { setSettings: React.Dispatch<React.SetStateAction<boolean>> }) {
  ...
  const handleDeleteProfile = () => {
    ...
    axios
      .delete(
        `${process.env.NEXT_PUBLIC_BACKENDAPI}/api/v1/users/delete`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
      ...
      .then((res) => {
        console.log(res.data);
        ToastNot("Profile deleted successfully");
        // Redirect to login or home page after deletion
        // You may want to clear the auth state here as well
        window.location.href = "/";
      })
      .catch((err) => {
        console.log(err);
        ToastNot("Error deleting profile");
        setIsDeleting(false);
      });
  };
      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainForm}>
          ...
          <div className={styles.dangerZone}>
            <h6 className={styles.dangerZoneTitle}>Danger Zone</h6>
